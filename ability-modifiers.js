(function(){
  const ABILITY_MODIFIERS = {
    ...
    "P'tarix's Sorcerous Syphon (Aura)": ['Conditional | Defense Attack: Wound Rolls -1 | Weapon is Psychic'],
    'Prey of the Blood God': ['Conditional | Unit-wide | Melee: Reroll Wounds'],
    'Prince of Darkness (Aura)': ['Conditional | Unit-wide | Defense: Cover'],
    'Rage Embodied (Aura)': ['Conditional | Unit-wide | Melee: Attacks +1'],
